...
def stopword(caption):
    ...
    caption_tokenized = word_tokenize(caption)
    caption_stopword = [word for word in caption_tokenized if not word in stopwordindo]
    # caption_stopword = stopwords(caption_stopword)
    captionfiltered_english = [word for word in caption_stopword if not word in stopwordenglish]
